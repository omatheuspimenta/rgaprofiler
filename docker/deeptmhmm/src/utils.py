...
#     esm_args = torch.load('esm_model_args.pt')
    esm_args = torch.load('esm_model_args.pt', weights_only=False)
    esm_alphabet = torch.load('esm_model_alphabet.pt', weights_only=False)
    esm_model_state_dict = torch.load('esm_model_state_dict.pt', weights_only=False)
